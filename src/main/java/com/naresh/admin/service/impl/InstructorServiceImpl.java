...
import com.naresh.admin.mapper.InstructorMapper;
import com.naresh.admin.service.CourseService;
import com.naresh.admin.service.InstructorService;
import com.naresh.admin.service.UserService;
...
public class InstructorServiceImpl implements InstructorService {
    ...
    public Page<InstructorDTO> findInstructorsByName(String name, int page, int size) {
        ...
        return new PageImpl<>(instructorsPage.getContent()
                .stream().map(instructor -> instructorMapper.fromInstructor(instructor))
